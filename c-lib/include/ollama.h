 ...
 * When changing OLLAMA_DEFAULT_*: follow `.cursor/default_models.md` (Python m4_default_models.py, docs, examples).
...
/* Default when no model passed and OLLAMA_MODEL unset. Query running Ollama with ollama_get_first_model() to use whatever is installed. */
#define OLLAMA_DEFAULT_MODEL "qwen2.5:14b"
